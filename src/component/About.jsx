    ...
    >
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row justify-evenly items-center w-fit  mx-auto  rounded-xl">
          <div className="w-1/2 before:bg-white before:absolute before:content-none">
            <img
              src="/me1.png"
              alt="me"
              className="rounded-full shadow-green-800 shadow-lg bg-[#13a0491a] h-[400px] w-[400px]"
            />
          </div>
          <div className="w-1/2 h-fit flex flex-col  py-[2%]">
