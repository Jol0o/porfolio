...
const Nav = () => {
  ...
  return (
    <div className="w-full fixed z-10">
      <div className=" flex justify-between md:justify-center items-center  h-14 text-[#9C9C9C] w-auto lg:min-w-[1200px] mx-auto px-[2%] bg-[#1B1B1B] rounded-b-lg relative ">
